 ...
 */
 ...
 #include "dfuthread.h"
#ifdef Q_OS_WIN
 #include "windows/dfudriverinstaller.h"
#endif
 #include <archive.h>
...
#ifdef Q_OS_WIN
    if (!DfuDriverInstaller::isDriverInstalled()) {
        emit dfuDriverRequired();
        return;
    }
#endif
...
bool ImageWriter::installDfuDriver()
{
#ifdef Q_OS_WIN
    return DfuDriverInstaller::installDriver();
#else
    return false;
#endif
}
