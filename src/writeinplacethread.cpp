...
void WriteInPlaceThread::run()
{
    ...
    // QObject::connect(th, &DownloadExtractThread::preparationStatusUpdate, this, &DownloadExtractThread::preparationStatusUpdate);
    ...
    if(false == transferInstance->setSerialPortAndConfigure(_selSerPort, SER_BAUDRATE))
    {
